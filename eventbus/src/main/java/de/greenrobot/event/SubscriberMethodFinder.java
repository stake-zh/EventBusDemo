        ...
        for (Method method : methods) {
            ...
            if (methodName.startsWith(ON_EVENT_METHOD_NAME)) {
                ...
                if ((modifiers & Modifier.PUBLIC) != 0 && (modifiers & MODIFIERS_IGNORE) == 0) {
                    ...
                    Log.d(EventBus.TAG, "Skipping method (not public, static or abstract): " + methodClass + "build/intermediates/exploded-aar/com.android.support/support-v4/23.1.1/res"
                            + methodName);
                }
            }
        }
